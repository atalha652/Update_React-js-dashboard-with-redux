...
import CustomCalenderControl from './custom_calender_control';
...
class FormRenderer extends Component {
    ...
    renderFields(fields, form) 
    {
        ...
        for (var idx in fields) 
        {
            ...
            {
                var fieldValue = (field.value && field.value !== null)?field.value:"";
                            ...
                            <div className="form-group form-group-float">
                                ...
                                <div className="form-group-feedback form-group-feedback-right">
                                    <DatePicker
                                        ...
                                        key={field.idx}
                                        autoComplete="off"
                                        customInput={<CustomCalenderControl clearable={field.clearable} fieldName={field.name} clearDate={this.clearDate.bind(this, field)}/>}
                                        name={field.name}
                ...
                else if (field.type === 'radio') 
                {
                    ...
                    for (var i in field.options) {
                        ...
                        if (!option.disable) {
                            __child.push(
                                    <label key={i} className="form-check-label mr-4">
                        ...
                        <div key={"field-" + idx} className={field.size}>
                            <div className="form-group">
                                ...
                                </label>
                                {
                                    ...
                                    <span className={field.isLoading?"badge badge-primary bg-theme ml-2 make-blur":"badge badge-primary bg-theme ml-2 c-hand"} onClick={this.addValue.bind(this, field)}>
